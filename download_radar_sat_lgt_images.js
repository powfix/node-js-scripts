...
const downloadImage = (date: Moment, resolution: number = 1440, retryCount: number = 0, ignoreError: boolean = true): Promise => new Promise((resolve, reject) => {
...
const taskIterator = (): Promise => {
	...
	++count;
	return downloadImage(time.add(5, 'minute'), 1440, 3, true);
}
